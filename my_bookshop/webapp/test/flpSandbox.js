			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mybookshop-display": {
								"semanticObject": "mybookshop",
								"action": "display",
								"description": "Um App Fiori - Livraria",
								"title": "Livraria",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mybookshop",
									"url": sap.ui.require.toUrl("mybookshop")
								}
							}
						}
					}
